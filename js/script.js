//Первый метот без Отдельной Функции
/*
...
//С Отдельной Функццией
function close_popup() {
  document.querySelector("header").classList.remove("open");
  header_button.querySelector("img").src = "icon/align_left.png";
}
...
header_button.addEventListener("click", function () {
  ...
  if (header.classList.contains("open")) {
    ...
    header_button.querySelector("img").src = "icon/close.png";
  }
});
